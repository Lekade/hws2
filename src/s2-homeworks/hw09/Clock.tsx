...
function Clock() {
    ...
    const onMouseEnter = (e:  React.MouseEvent<HTMLDivElement, MouseEvent> ) => { // пишут студенты // показать дату если наведена мышка
        setShow(true)
    }
    const onMouseLeave = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => { // пишут студенты // спрятать дату если мышка не наведена
        setShow(false)
    }
